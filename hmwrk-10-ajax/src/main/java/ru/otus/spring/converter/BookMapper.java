...
public class BookMapper {
    ...
    public Book toEntity(BookCreateDto bookCreateDto, Author author, List<Genre> genres) {
        Book book = new Book();
    ...
    public Book toEntity(Book existingBook, BookUpdateDto bookUpdateDto, Author author, List<Genre> genres) {
